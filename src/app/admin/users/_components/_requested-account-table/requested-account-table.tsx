...
import { userTableColumns } from "../_users-table/users-table-columns";
...
import { requestedAccountTableColumns } from "./requested-account-table-columns";
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  key={row.id}
                  data-state={row.getIsSelected() && "selecionada"}
                >
